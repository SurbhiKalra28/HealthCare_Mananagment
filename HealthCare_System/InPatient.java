...
public class InPatient <T extends Patient> extends Patient {
    ...
    public InPatient(int patientID, String patientName, List<MedicalRecord> medRecordList, String admissionDate, String roomNumber) {
        super(patientID, patientName, medRecordList);
        this.admissionDate = admissionDate;
        this.roomNumber = roomNumber;
    }
